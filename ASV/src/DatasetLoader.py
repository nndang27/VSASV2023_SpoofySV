...
class AugmentWAV(object):
	...
	def __init__(self, musan_path, rir_path, max_frames):
		...
		if not augment_files:
			print("No musan WAV files found in the provided directory.")
		...
		if not self.rir_files:
			print("No rir WAV files found in the provided directory.")
